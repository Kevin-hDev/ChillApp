                          ...
                          children: [
                            ...
                            IconButton(
                              ...
                              onPressed: info.isLoading
                                  ? null
                                  : () => ref
                                        .read(connectionInfoProvider.notifier)
                                        .fetchAll(force: true),
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: [
        ...
        Row(
          children: [
            Icon(widget.icon, size: 18, color: context.chillTextSecondary),
            const SizedBox(width: 8),
            Text(
              widget.label,
              style: theme.textTheme.bodyMedium?.copyWith(
...
class _TailscaleRecommendCard extends StatelessWidget {
  ...
  const _TailscaleRecommendCard({required this.locale, required this.onTap});
