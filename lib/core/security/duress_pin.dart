...
// Cible: lib/core/security/duress_pin.dart
// =============================================================
//
...
class DuressPin {
  ...
  static String hashPin(String pin, String salt, int iterations) {
    return _hashPin(pin, salt, iterations);
  }

  /// Implementation interne du hash PBKDF2-HMAC-SHA256.
